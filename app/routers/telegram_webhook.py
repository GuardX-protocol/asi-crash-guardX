    ...
    try:
        ...
        if existing_user:
            ...
            if is_connected():
                ...
                updated_user = await fallback_storage.update_user(existing_user.walletAddress, update_data)
            ...
            if is_connected():
                ...
                monitors = await fallback_storage.get_monitors(existing_user.walletAddress)
                active_monitors = len([m for m in monitors if m.enabled])
